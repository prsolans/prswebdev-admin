...
use PRS\ResumeBundle\Form\ProjectType;
use PRS\ResumeBundle\Form\ProjectFilterType;
...
class ProjectController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('PRSResumeBundle:Project')->createQueryBuilder('e');
    ...
    */
     ...
     * @Method("POST")
     * @Template("PRSResumeBundle:Project:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PRSResumeBundle:Project')->find($id);
     ...
     * @Method("PUT")
     * @Template("PRSResumeBundle:Project:edit.html.twig")
     */
